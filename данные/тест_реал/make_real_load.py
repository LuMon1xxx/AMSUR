...
# Производные перекрытия (документированы, на подтверждение учеником):
# Авдеёнок к/ч считается за 5в (иначе 5в без классного, а 5б двоится);
# 5б к/ч — Королёнок.
OVERRIDE = {("5В", "Классный час"): [(5, 1)], ("5Б", "Классный час"): [(47, 1)]}
